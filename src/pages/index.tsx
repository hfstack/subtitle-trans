...
const HomePage: React.FC = () => {
  ...
  const steps = [
    { title: '上传字幕', component: <SubtitleUploader /> },
    { title: '字幕修复', component: <SubtitleRepairForm onComplete={(content) => {
      setProcessedContent(content);
      setCurrentStep(2);
    }} /> },
    { title: '添加表情', component: <SubtitleEmojiForm initialContent={processedContent} onComplete={(content) => {
      setProcessedContent(content);
      setCurrentStep(3);
    }} /> },
    { title: '字幕翻译', component: <SubtitleTranslateForm initialContent={processedContent} onComplete={(content) => {
      setProcessedContent(content);
      setCurrentStep(4);
    }} /> },
    { title: '转语音', component: <SubtitleTTSForm initialContent={processedContent} /> }
  ];
  ...
  return (
    <MainLayout title="字幕工作流 - 字幕工具箱">
      <div className="bg-white shadow sm:rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h1 className="text-lg font-medium leading-6 text-gray-900">字幕处理工作流</h1>
